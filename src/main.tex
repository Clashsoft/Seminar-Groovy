...
Die Variable in Zeile 4 hat den statischen Typ \code{Object}, ihr Wert ist zur Laufzeit aber vom Typ \code{String}.
Dadurch wählt die Groovy-Laufzeitumgebung bei dem Aufruf in Zeile 5 dynamisch die \code{take(String)}-Methode aus.
...
Die 5.~Zeile zeigt, dass der Index-Operator auch mehrere Argumente sowie Intervalle unterstützt.
