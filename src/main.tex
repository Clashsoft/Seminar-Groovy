...
\subsubsection{Standardbibliothek und Erweiterungen}\ref{subsubsec:standard-bibliothek}
...
Besonders ist, dass darin auch Klassen aus dem JDK erweitert.
...
Die Klasse \code{String} wird dabei auch als Collection (von Zeichen) behandelt und kann ebenso verwendet werden.
\code{File} und andere IO-Klassen besitzen Erweiterungen für die Iteration über Bytes, Zeichen und Zeilen.
