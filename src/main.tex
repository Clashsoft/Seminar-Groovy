...
Semantisch sind jedoch einige Unterschiede zu Java zu finden, weshalb in Unterabschnitt~\ref{subsec:vergleichMitJava} ein Vergleich der Sprachen durchgeführt wird und in~\ref{subsec:typisierung} weitere Unterschiede in der Typisierung betrachtet werden.
